...
export default function PedidosPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-6">
      ...
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Os Meus Pedidos</h1>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-gray-900 dark:text-white">{new Intl.NumberFormat('pt-AO', { style: 'decimal' }).format(order.total)} Kz</span>
                </div>
              </div>
            </Link>
          ))}
