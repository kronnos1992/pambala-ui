            ...
            <table className="w-full">
              <thead>
                <tr className="text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50">
                  <th className="px-6 py-3">{t('header.product')}</th>
                  <th className="px-6 py-3">{t('header.price')}</th>
                  <th className="px-6 py-3">{t('header.stock')}</th>
                  <th className="px-6 py-3">{t('header.sales')}</th>
                  <th className="px-6 py-3">{t('header.status')}</th>
                  <th className="px-6 py-3 text-right">{t('header.actions')}</th>
                </tr>
              </thead>
                  ...
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-3">
                      <span className={cn(
                        ...
                        {(product.stock || 0) > 0 ? t('status.active') : t('status.inactive')}
                      </span>
                    </td>
                    <td className="px-6 py-3">
