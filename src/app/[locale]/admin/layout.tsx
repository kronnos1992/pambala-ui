    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center dark:bg-[#0a0f1a]">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-950 dark:text-white mb-2">{t('restrictedAccess')}</h2>
          <p className="text-gray-600 dark:text-gray-200 mb-4">{t('restrictedAccessHint')}</p>
          <Link href="/" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 font-medium">{t('backToHome')}</Link>
        </div>
      </div>
    )
  }
        ...
        <aside className={cn(
          ...
          <div className="flex h-16 items-center justify-between border-b border-gray-100 dark:border-gray-700/50 px-5">
            <Link href="/admin" className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-950 dark:text-white">{t('panelName')}</span>
            </Link>
