  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Gerir Produtos</h1>
        <span className="text-sm text-gray-500">{pagination.total} produtos</span>
      </div>
          ...
          {['', 'true', 'false'].map((v) => (
            <button
              ...
              className={cn(
                ...
                active === v ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              )}
            >
              ...
              <tbody className="divide-y divide-gray-100">
                {products.map((product) => (
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600">{product.store?.name || '-'}</td>
                ...
                {products.length === 0 && (
                  <tr><td colSpan={8} className="px-6 py-8 text-center text-gray-500 text-sm">Nenhum produto encontrado.</td></tr>
                )}
              </tbody>
            </table>
          </div>
