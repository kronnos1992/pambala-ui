        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">Adicione produtos ao seu carrinho.</p>
              ...
              {items.map((item) => (
                <div key={item.id} className="flex gap-3 rounded-lg border border-gray-100 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-bold text-emerald-700 mt-0.5">{formatPrice(item.price)}</p>
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <div className="flex items-center gap-2 rounded-lg border border-gray-200">
                        ...
                        <button
                          ...
                          className="flex h-7 w-7 items-center justify-center text-gray-500 hover:text-gray-700 disabled:opacity-40"
                        >
